...
#endif
// ----------------------------------------------------------------------------------------
void line_fermeture3_ui32matrix_swp32_fusion(uint32 **X, int i, int j0, int j1, uint32 **Y)
// ----------------------------------------------------------------------------------------
{
    // TODO
}
...
// --------------------------------------------------------------------------------------------
void fermeture3_ui32matrix_swp32_fusion(uint32 **X, int i0, int i1, int j0, int j1, uint32 **Y)
// --------------------------------------------------------------------------------------------
{
    for(int i=i0; i<=i1; i++) {
        line_fermeture3_ui32matrix_swp32_fusion(X, i, j0, j1, Y);
    }
}
// -------------------------------------------------------------------------------------------------
