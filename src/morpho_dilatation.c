...
// --------------------------------------------------------------------------------------
{
    ...
    if (r) {
        line_dilatation3_ui8matrix_elu2_red(X, i-1, j0, j1, Y);
    }
}
// ---------------------------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------------------------
{
    ...
    if (r) {
        line_dilatation3_ui8matrix_elu2_red_factor(X, i-1, j0, j1, Y);
    }
}
// -------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------
{
    ...
    if (r) {
        line_dilatation3_ui8matrix_ilu3_elu2_red(X, i-1, j0, j1, Y);
    }
}
// --------------------------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------------------------
{
    ...
    if (r) {
        line_dilatation3_ui8matrix_ilu3_elu2_red_factor(X, i-1, j0, j1, Y);
    }
}
