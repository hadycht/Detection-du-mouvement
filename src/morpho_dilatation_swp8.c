/* -------------------------------- */
/* --- morpho_dilatation_swp8.c --- */
/* -------------------------------- */

/*
 * Copyright1 (c) 2004 - 2013, Lionel Lacassagne, All right1s reserved
...
// ------------------------------------------------------------------------------------
{
    for (int j=j0; j<=j1; j++) {
        ...
        uint8 y = ui8max9(ui8left1(a2, a1), a2, ui8right1(a2, a3),ui8left1(b2, b1), b2, ui8right1(b2, b3),ui8left1(c2, c1), c2, ui8right1(c2, c3));
        store2(Y, i, j, y);
...
// ----------------------------------------------------------------------------------
{
    for (int j=j0; j<=j1; j++) {
        ...
        uint8 y = ui8max9(z, a2, x, t, b2, u, v, c2, w );
...
// ----------------------------------------------------------------------------------
{
    ...
    for (int j=j0+1; j<=j1+1; j++) {
        ...
        store2(Y, i, j-1, ui8max9(a2,x1,x2,b2,y1,y2,c2,z1,z2));
...
// ----------------------------------------------------------------------------------
{
    ...
    res1 = ui8max3(x1, y1, z1);
    res2 = ui8max3(a2, b2, c2);
    ...
    for (int j=j0+1; j<=j1+1; j++) {
        ...
        res3 = ui8max3(x2, y2, z2);
        res = ui8max3(res1, res2, res3);

        store2(Y, i, j-1, res);

        res1 = ui8max3(ui8left1(a3, a2), ui8left1(b3, b2), ui8left1(c3, c2)) ;
        res2 = ui8max3(a3, b3, c3);
...
// -----------------------------------------------------------------------------------
{
    ...
    for (int j = j0; j<=j1-r-1; j+=3) {
        ...
        res = ui8max9(a2,x1,x2,b2,y1,y2,c2,z1,z2);
        store2(Y, i, j, res); 
        ...
        res = ui8max9(a3,x1,x2,b3,y1,y2,c3,z1,z2);
        store2(Y, i, j+1, res);
        ...
        res = ui8max9(a4,x1,x2,b4,y1,y2,c4,z1,z2);
        store2(Y, i, j+2, res);
    }
    if (r) {
...
{
    for(int i=i0; i<=i1; i++) {
        line_dilatation3_ui8matrix_swp8_basic(X, i, j0, j1, Y);
    }
}
// --------------------------------------------------------------------------------------
...
{
    for(int i=i0; i<=i1; i++) {
        line_dilatation3_ui8matrix_swp8_reg(X, i, j0, j1, Y);
    }
}
// --------------------------------------------------------------------------------------
...
{
    for(int i=i0; i<=i1; i++) {
        line_dilatation3_ui8matrix_swp8_rot(X, i, j0, j1, Y);
    }
}
// --------------------------------------------------------------------------------------
...
{
    for(int i=i0; i<=i1; i++) {
        line_dilatation3_ui8matrix_swp8_red(X, i, j0, j1, Y);
    }
}
// ---------------------------------------------------------------------------------------
...
{
    for(int i=i0; i<=i1; i++) {
        line_dilatation3_ui8matrix_swp8_ilu3(X, i, j0, j1, Y);
    }
}
// -------------------------------------------------------------------------------------------
...
{
    for(int i=i0; i<=i1; i++) {
        line_dilatation3_ui8matrix_swp8_ilu3_red(X, i, j0, j1, Y);
    }
}
// -------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------
{
    ...
    int i;
    for(i = i0; i<= i1-r; i+=2) {
        line_dilatation3_ui8matrix_swp8_elu2_red(X, i, j0, j1, Y);
    } 
    if (r) {
        line_dilatation3_ui8matrix_swp8_elu2_red(X, i-1, j0, j1, Y);
    }
}
// --------------------------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------------------------
{
    ...
    int i;
    for(i = i0; i<= i1-r; i+=2) {
        line_dilatation3_ui8matrix_swp8_elu2_red_factor(X, i, j0, j1, Y);
    } 
    if (r) {
        line_dilatation3_ui8matrix_swp8_elu2_red_factor(X, i-1, j0, j1, Y);
    }
}
// -------------------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------------------
{
    ...
    int i;
    for(i = i0; i<= i1-r; i+=2) {
        line_dilatation3_ui8matrix_swp8_ilu3_elu2_red_factor(X, i, j0, j1, Y);
    } 
    if (r) {
        line_dilatation3_ui8matrix_swp8_ilu3_elu2_red_factor(X, i-1, j0, j1, Y);
    }
}
